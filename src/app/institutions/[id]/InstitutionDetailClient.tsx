    ...
    <div className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6">
            ...
            teklifWhatsAppHrefForProgram={
              hasWhatsAppNumber
                ? (programTitle) =>
                    institutionWhatsAppHref(
                      institution,
                      `Merhaba, ${institution.name} — "${programTitle}" programı için teklif almak istiyorum.`,
                    )
                : undefined
            }
          />
      ...
      {hasWhatsAppNumber ? (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-5 right-4 z-[60] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_4px_20px_rgba(0,0,0,0.2)] ring-2 ring-white/90 transition hover:bg-[#20bd5a] hover:shadow-[0_6px_24px_rgba(0,0,0,0.25)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 sm:bottom-6 sm:right-6"
          aria-label={`${institution.name} — WhatsApp ile yazın`}
          title="WhatsApp"
        >
